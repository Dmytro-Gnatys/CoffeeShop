            ...
            <div className="header_wreapper">
                <ul className="header_menu">
                    ...
                    <li className="header_menu_item">
                        <Link to="/" className="header_menu_link">Home</Link>
                    </li>
                    <li className="header_menu_item">
                        <Link to="/coffee" className="header_menu_link">Our coffee</Link>
                    </li>
                    <li className="header_menu_item">
                        <Link to="/coffee/:coffeeId" className="header_menu_link">Coffee house</Link>
                    </li>
                </ul>
