...
const BuyCoffeeList = (props) => {
    ...
    return (
        <section className="product">
            ...
            <div className="product__title">{props.name} : {props.country}</div>
                ...
                <div className="count">
                    ...
                    <div className="count__controls">
                        ...
                        <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13 7L7 1L1 7" stroke="#A0BBCC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" alt="Increase"/>
                        </svg>
                        </button>
                        <button 
                        type="button" 
                        ...
                        >
                        <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 1L7 7L13 1" stroke="#A0BBCC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" alt="Decrease"/>
                        </svg>
                        </button>
                    </div>
                </div>
            ...
            <div className="product__controls">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M6 6L18 18" stroke="#7E9BBD" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" alt="Delete"/>
                </svg>
                </button>
            </div>
        </section>
