                ...
                <div className="about_wrapper">
                    ...
                    <div className="about_item_text">
                        <div className="about_item_text-title">About It</div>
                            <CoffeeLine/>
                        <div className="about_item_text-country">Country: {selected ? selected.country : ''}</div>
                        <div className="about_item_text-descr">Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                        <div className="about_item_text-buy">
                            <div className="about_item_text-price">Price: {selected ? selected.price : ''}$</div>
                            <div className="about_item_text-btn">
                                <Link to={`/coffee/${selected ? selected.id : ''}/buy`} className="about_item_text-btn-link">Buy</Link>
